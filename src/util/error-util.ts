...
export const processDestroyExit = async () => {
  ...
  clearConsoleBuffer();
  console.log("Goodbye from Z3ro Cash! 👋");
};

export const processSafeExit = async () => {
  console.log("Shutting Down Z3ro Cash Modules");
  clearConsoleBuffer();
  await killEngineAndWaku();
  console.clear();
  process.exit(0);
...
export const setConsoleTitle = (
  titleMessage = "🔐 Z3RO CASH - Privacy-First Terminal Wallet",
) => {
