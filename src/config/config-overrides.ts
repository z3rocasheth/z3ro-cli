...
export const versionCheck = (version: string) => {
    ...
    if (version < remoteConfig.minVersionNumber) {
        ...
        console.log('DEPRECATED Version. Download @', "https://z3ro.cash".bgBlue);
        process.exit(69);
    }
    if (version < remoteConfig.currentVersionNumber) {
        console.log('Theres a new version available!!'.rainbow, "Download Links:".zebra, "https://z3ro.cash".bgBlue)
    }
}